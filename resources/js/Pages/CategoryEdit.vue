...
// Submit the form
function submit() {
    form.put(route('category.update', props.Category.id), { // Assuming route is category.update
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
            form.reset();
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] p-6 flex items-center justify-center">
        <div class="w-full max-w-2xl bg-white/10 backdrop-blur-md text-white rounded-2xl shadow-2xl p-8 border border-white/10">
            <h2 class="text-3xl font-bold text-center mb-8">Edit Category</h2>
